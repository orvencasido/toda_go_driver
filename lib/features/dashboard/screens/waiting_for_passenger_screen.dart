...
class _WaitingForPassengerScreenState extends State<WaitingForPassengerScreen> {
  final ll.LatLng _driverLocation = const ll.LatLng(14.0256, 121.5831); // Example coordinates
  final ll.LatLng _passengerLocation = const ll.LatLng(14.0260, 121.5840);
            ...
            child: Stack(
              children: [
                OpenStreetMapWidget(
                  ...
                  pickupLocation: _passengerLocation,
